...
# Sendgrid templates
SENDGRID_TPL_NEW_LOCATION = os.environ.get("SENDGRID_TPL_NEW_LOCATION")
SENDGRID_TPL_LOCATION_CHANGE_PROPOSAL = os.environ.get(
    "SENDGRID_TPL_LOCATION_CHANGE_PROPOSAL"
)
SENDGRID_TPL_LOCATION_FLAG_SUPERADMIN = os.environ.get(
    "SENDGRID_TPL_LOCATION_FLAG_SUPERADMIN"
)
SENDGRID_TPL_LOCATION_FLAG_MANAGER = os.environ.get(
    "SENDGRID_TPL_LOCATION_FLAG_MANAGER"
)
